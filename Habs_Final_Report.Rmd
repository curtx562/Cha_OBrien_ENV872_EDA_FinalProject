...
```{r Alexandrium in Newport Pier: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
...
```{r Alexandrium in San Luis Obispo: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
CalPoly <- hab_occ_wq %>%
...
```{r Alexandrium in Santa Monica: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
...
```{r Alexandrium in San Diego: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
SanDiego <- hab_occ_wq %>%
...
```{r Alexandrium in Santa Barbara: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
...
```{r Pseudo-nitzschia seriata in San Luis Obispo: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
CalPoly <- hab_occ_wq %>%
  filter(locationID == "CalPoly")
...
```{r Pseudo-nitzschia seriata in Santa Monica: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
SantaMonica <- hab_occ_wq %>%
  filter(locationID == "SantaMonicaPier")
...
```{r Pseudo-nitzschia seriata in Newport: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
NewportPier <- hab_occ_wq %>%
  filter(locationID == "NewportPier")
...
```{r Pseudo-nitzschia seriata in Santa Barbara: time series and AIC, echo = FALSE, eval = FALSE}
#specify location
SantaBarbara <- hab_occ_wq %>%
  filter(locationID == "StearnsWharf")
