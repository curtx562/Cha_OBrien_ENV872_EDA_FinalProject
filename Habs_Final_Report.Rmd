...
setwd("../Cha_OBrien_ENV872_EDA_FinalProject")
getwd()
...
#this table will be used to obserev the date ranges for each site location
...
```{r Exploratory Analysis, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 6}
...
```{r Exploratory Analysis Part 2 SST, echo = FALSE, message = FALSE, warning  = FALSE}
...
plot_grid(title_sst, sst, ncol = 1, rel_heights = c(0.15,1))
...
```{r Exploratory Analysis Part 3, echo = FALSE, message = FALSE, warning  = FALSE}
...
```{r combining figures, echo = FALSE, message = FALSE, warning  = FALSE, fig.width = 7, fig.height = 4}
#generate titles
title_pn <- ggdraw() + 
  draw_label(
...
plot_grid(title_al, AL.Monthly.Fig, ncol = 1, rel_heights = c(0.15, 1))
```
