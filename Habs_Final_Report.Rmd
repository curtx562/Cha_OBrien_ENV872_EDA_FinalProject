...
title_sst <- ggdraw() + 
  draw_label(
    "Figure 2: Sea Surface Temperature by Location",
    fontface = 'bold',
    x = 0,
    hjust = 0
  ) +
...
title_pn <- ggdraw() + 
  draw_label(
    "Fig. 4 Mean Monthly Pseudo-nitzschia Concentrations",
    fontface = 'bold',
    x = 0,
    hjust = 0
  ) +
...
title_al <- ggdraw() + 
  draw_label(
    "Fig. 5 Mean Monthly Alexandrium Concentrations",
    fontface = 'bold',
    x = 0,
    hjust = 0
  ) +
...
kable(pn_lms, caption = "Coefficients for Pseudo-nitzschia Linear Models", booktabs=TRUE, format="latex", longtable=TRUE) %>%
  kable_styling(latex_options="HOLD_position", font  = 9)

kable(pn_lms, caption = "Coefficients for Alexandrium Linear Models", booktabs=TRUE, format="latex", longtable=TRUE) %>%
  kable_styling(latex_options="HOLD_position", font = 9)
```
